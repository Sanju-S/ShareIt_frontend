...
const HomePage = () => {
  ...
  let FRONT_URL = "https://share-it-frontend.vercel.app/";
  ...
  return (
    <div className="relative">
      <div
        className={`mx-auto max-w-screen-lg relative ${
      ...
      >
        ...
        <div className="shadow-lg flex flex-col items-center space-y-2 pb-5 max-w-screen-md mx-auto">
          ...
          <p>
            <span className="font-bold">ShortIt</span> is a free tool to shorten
            a URL or reduce a link
          </p>
          <p>
